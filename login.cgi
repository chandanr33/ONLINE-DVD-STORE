...
sub authenticate_user {
    ...
    open DATA, "</srv/www/cgi-bin/jadrn032/session_cookies/passwords.dat" 
...
<head>
    <meta http-equiv="refresh" 
        content="0; url=http://jadran.sdsu.edu/~jadrn032/proj1/error.html" />
</head><body></body>
</html>
...
# WATCH YOUR COOKIE NAMES! USE JADRNXXX_SID  
    ...
    $session->expires('+1d');
    my $cookie = $q->cookie(jadrn032SID => $session->id);
...
<head>
  <meta http-equiv="refresh" 
        content="0; url=http://jadran.sdsu.edu/~jadrn032/proj1/main.html" />  
</head>
<body>
